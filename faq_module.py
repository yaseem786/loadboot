...
def faq_page(cats):
    ...
    body += ('<div class="fq-none" id="fqNone">&#129301; Nothing matched — try a different word, or just ask in the chat bubble (bottom right). It answers instantly.</div>'
             ...
             '<a href="tel:+14692537575" data-lb-callonly><span class="ic">&#128222;</span><b>Call +1 (469) 253-7575</b><p>24/7 line. Prefer we call you? Ask in chat and pick a time.</p></a>'
             '<a href="#" data-lb-waonly style="display:none"><span class="ic">&#128172;</span><b>WhatsApp <span data-lb-wa-num></span></b><p>Message the dispatch desk on WhatsApp &mdash; replies in minutes, 24/7.</p></a>'
