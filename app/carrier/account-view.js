...
export async function renderPremiumAccount(host, ctx) {
  ...
  host.innerHTML = ''
    ...
    +   '<div class="row"><div><div class="rt">Marketing emails</div><div class="rs">Offers, news and tips</div></div><div class="tg' + (prefs.marketing_email !== false ? ' on' : '') + '" data-pref="marketing_email"></div></div>'
    +   '<div class="row"><div><div class="rt">Product announcements</div><div class="rs">New features &amp; important changes</div></div><div class="tg' + (prefs.product_announcements !== false ? ' on' : '') + '" data-pref="product_announcements"></div></div>'
    +   '<div class="row"><div><div class="rt">Pause all optional emails</div><div class="rs">Operational alerts (trips, payments, compliance) still reach you</div></div><div class="tg' + (prefs.unsubscribed_all ? ' on' : '') + '" data-pref="unsubscribed_all"></div></div></div>'
    ...
    +   '<a class="btn block" style="text-decoration:none;margin-bottom:9px" href="https://wa.me/18153651168" target="_blank" rel="noopener">&#128172; WhatsApp us</a>'
