...
export async function renderPremiumAccount(host, ctx) {
  ...
  host.innerHTML = ''
    ...
    + '<div class="card"><div class="sec-h"><div class="sec-ico ic-navy">' + sic('file') + '</div><div class="sec-t">Legal &amp; policies</div></div>'
    ...
    + '<div class="card dangerc"><div class="sec-h"><div class="sec-ico ic-red">' + sic('alert') + '</div><div class="sec-t">Danger zone</div></div><div class="sec-s">Pause new load offers or close your account. A person handles every request — nothing happens automatically.</div>'
  ...
  (function () {
    ...
    const layout = () => {
      ...
      const COL1 = ['s-profile', 's-verify', 's-biz', 's-pay', 's-support'];
