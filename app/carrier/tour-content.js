...
const OWNER = [
  ...
  { id: 'dash.kpis', screen: 'dashboard', route: '#dashboard', chapter: 'Your day', icon: 'grid',
    target: ['[data-tour="dash-kpis"]', '.cp-kpis', '.cp-content'],
  ...
  { id: 'dash.setup', screen: 'dashboard', chapter: 'Your day', icon: 'shield', tone: 'orange',
    target: ['[data-tour="dash-setup"]', '.cp-content .cp-card'],
  ...
  { id: 'loads.board', screen: 'loads', route: '#loads', chapter: 'Finding loads', icon: 'search',
    target: ['[data-tour="loads-list"]', '.cp-loadgrid', '.cp-content'],
  ...
  { id: 'loads.filters', screen: 'loads', chapter: 'Finding loads', icon: 'filter',
    target: ['[data-tour="loads-filters"]', '.cp-content .cp-card'],
  ...
  { id: 'trips.list', screen: 'trips', route: '#trips', chapter: 'On the road', icon: 'route',
    target: ['[data-tour="trips-list"]', '.cp-content'],
  ...
  { id: 'docs', screen: 'documents', route: '#documents', chapter: 'Paperwork', icon: 'doc',
    target: ['[data-tour="docs-list"]', '.cp-content'],
  ...
  { id: 'finance', screen: 'finance', route: '#finance', chapter: 'Your money', icon: 'dollar', tone: 'green',
    target: ['[data-tour="fin-summary"]', '.cp-content'],
  ...
  { id: 'dispatcher', screen: 'dispatcher', route: '#dispatcher', chapter: 'Extra hands', icon: 'handshake',
    target: ['[data-tour="disp-hero"]', '.dd-hero', '.cp-content'],
...
const DRIVER = [
  ...
  { id: 'today', screen: 'dashboard', route: '#dashboard', chapter: 'Today', icon: 'grid',
    target: ['[data-tour="today"]', '.cp-content'],
  ...
  { id: 'trips.actions', screen: 'trips', chapter: 'On the road', icon: 'check', tone: 'green',
  ...
  { id: 'pod', screen: 'trips', chapter: 'On the road', icon: 'upload',
...
const DISPATCHER = [
  ...
  { id: 'today', screen: 'dashboard', route: '#dashboard', chapter: 'Your day', icon: 'grid',
    target: ['[data-tour="dash-kpis"]', '[data-tour="today"]', '.cp-kpis', '.cp-content'],
  ...
  { id: 'fleet', screen: 'fleet', route: '#fleet', chapter: 'Trucks and drivers', icon: 'truck',
    target: ['[data-tour="fleet-list"]', '.cp-content'],
