...
function loginView() {
  ...
  mount(root, h('div', { class: 'pk-login' }, [
    h('div', { class: 'pk-brand', style: 'display:flex;align-items:center' }, [h('img', { src: '/logo-full-dark.png', alt: 'LoadBoot', style: 'height:29px;width:auto;display:block' })]),
...
async function appView() {
  ...
  const top = h('div', { class: 'pk-top' }, [
    h('div', { class: 'pk-brand', style: 'display:flex;align-items:center;gap:7px' }, [h('img', { src: '/logo-full-dark.png', alt: 'LoadBoot', style: 'height:26px;width:auto;display:block' }), h('span', { style: 'opacity:.7;font-size:12px;font-weight:700' }, 'Pocket')]),
