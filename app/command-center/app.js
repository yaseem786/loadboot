...
async function boot() {
  ...
  let automationEnabled = false, crmEnabled = false, complianceEnabled = false;
  ...
  const shell = renderShell(root, user, { automation: automationEnabled, crm: crmEnabled, compliance: complianceEnabled });
