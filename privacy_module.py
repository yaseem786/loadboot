...
<div class="pv-stamp"><b>This page is the LoadBoot Privacy Policy.</b> Last updated <b>6 September 2026</b> &middot; LoadBoot LLC &middot; applies to loadboot.com, the Carrier, Partner, Agent and Developer portals, and the LoadBoot Android app</div>
    ...
    b += _sec('sms', 'Text messages (SMS)', 'When we text you, and what happens to your number',
        ...
        '<p><b>How you opt in.</b> There is one way to opt in: on the carrier-portal registration form at <a href="https://loadboot.com/app/carrier/">loadboot.com/app/carrier/</a>, under the mobile number field, there is a separate checkbox &mdash; unchecked by default &mdash; that reads &ldquo;Optional &mdash; tick to agree to receive text messages from LoadBoot at the mobile number above about your loads and account (dispatch updates, check calls, paperwork requests).&rdquo; You only receive texts if you tick it yourself. Leaving it unticked does not stop you from creating an account or using LoadBoot, and consent to receive texts is not a condition of buying anything. We record the date and time you ticked the box. You can withdraw consent at any time by replying STOP to any message or emailing <a href="mailto:hello@loadboot.com">hello@loadboot.com</a>.</p>'
