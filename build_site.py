...
intg += docsec('Live today', 'Developer platform',
 ...
 '<p><b>ELD &amp; telematics ingest</b> — every carrier gets a secure webhook: point Motive, Samsara, Garmin or any device that can POST a position at it, and truck GPS feeds the active trip automatically — even with the app closed. (Carrier portal &rarr; Fleet &rarr; ELD &amp; telematics.)</p>'
