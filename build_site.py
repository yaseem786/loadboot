...
<a class="logo" href="index.html" aria-label="LoadBoot home"><img src="/logo-full.png" alt="LoadBoot" height="34" style="display:block;height:34px;width:auto"></a>
...
<div class="foot-top">
<div><div class="logo"><img src="/logo-full-dark.png" alt="LoadBoot" height="30" style="display:block;height:30px;width:auto"></div>
...
<link rel="stylesheet" href="styles.css?v=6">%s</head><body><script>(function(){try{if(sessionStorage.getItem('lb_seen'))return;}catch(e){}var o=document.createElement('div');o.id='lbSplash';o.innerHTML='<div class="lbs-logo"><img class="lbs-arw" src="data:image/png;base64," alt="" aria-hidden="true"><img class="lbs-wm" src="data:image/png;base64," alt="LoadBoot"><span class="lbs-shine"></span></div>';document.body.insertBefore(o,document.body.firstChild);try{sessionStorage.setItem('lb_seen','1');}catch(e){}setTimeout(function(){if(o&&o.parentNode)o.parentNode.removeChild(o);},2350);})();</script>
%s
%s
%s
<script>%s</script>
...
'''
SPLASH_CSS = '''
#lbSplash{position:fixed;inset:0;z-index:99999;background:radial-gradient(1000px 520px at 50% 34%,#13213f 0%,#0b1220 62%,#070d1a 100%);display:flex;align-items:center;justify-content:center;animation:lbsOut .55s ease 1.75s forwards}
.lbs-logo{position:relative;display:flex;align-items:center;gap:14px;padding:8px 12px}
.lbs-arw{height:60px;width:auto;display:block;filter:drop-shadow(0 14px 32px rgba(8,131,247,.5));animation:lbsArw 1s cubic-bezier(.16,.9,.3,1.35) both}
.lbs-wm{height:42px;width:auto;display:block;clip-path:inset(0 100% 0 0);animation:lbsWipe .7s .55s cubic-bezier(.4,0,.2,1) forwards}
.lbs-shine{position:absolute;inset:0;overflow:hidden;pointer-events:none}
.lbs-shine::after{content:"";position:absolute;top:-20%;bottom:-20%;left:-45%;width:32%;background:linear-gradient(100deg,transparent,rgba(255,255,255,.35),transparent);transform:skewX(-18deg);animation:lbsShine 1.3s 1.15s ease-out both}
@keyframes lbsArw{0%{opacity:0;transform:translateX(-70px) scale(.78)}55%{opacity:1}100%{opacity:1;transform:translateX(0) scale(1)}}
@keyframes lbsWipe{0%{clip-path:inset(0 100% 0 0)}100%{clip-path:inset(0 0 0 0)}}
@keyframes lbsShine{0%{left:-45%}100%{left:135%}}
@keyframes lbsOut{to{opacity:0;visibility:hidden}}
@media(prefers-reduced-motion:reduce){#lbSplash{animation:lbsOut .3s ease .2s forwards}.lbs-arw,.lbs-wm{animation:none;opacity:1;clip-path:none;transform:none}.lbs-shine::after{animation:none;opacity:0}}
'''
ART_CSS = '''
