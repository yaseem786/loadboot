...
intg += ('<section class="ftx-sec"><div class="wrap"><div class="sec-head reveal"><div class="eyebrow">For brokers, shippers &amp; builders</div><h2>An API that speaks TMS</h2></div>'
 ...
 '<div class="card"><div class="icon">&#128202;</div><h3>Fleet analytics</h3><p>Per-truck utilization, $/mile and best-paying lanes computed from real delivered trips &mdash; no BI project required.</p></div>'
 '</div>'
 '<div class="cards g1 reveal" style="margin-top:18px"><div class="card"><h3>&#128679; The honest roadmap</h3><p>Not live yet, and clearly labeled: fuel-card <i>provider APIs</i> (beyond statement import) and multi-fleet enterprise optimization. When each ships it is documented here first. Want one prioritized? <a href="contact.html">Tell us</a> &mdash; real demand moves the roadmap.</p></div></div>'
 '</div></section>')
