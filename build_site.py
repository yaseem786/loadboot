...
pr_body += ('<section class="bg-soft"><div class="wrap"><div class="sec-head center reveal"><div class="eyebrow">Every side, priced in the open</div><h2>What each side of a load pays</h2>'
 ...
 '<div class="card"><div class="icon">&#129309;</div><h3>Agents</h3><p><b>Free to join &mdash; you get paid.</b> 1% of gross on every delivered load your referred clients move, plus 0.50% / 0.25% / 0.15% / 0.10% overrides five levels deep. Paid out of LoadBoot&rsquo;s own 5% &mdash; never added to anyone&rsquo;s cost.</p></div>'
 '</div></div></section>')
...
dsp += _sec('Equipment we dispatch', 'Every trailer type, every lane', _cards([
 ('&#128667;','Dry van dispatch','Van freight nationwide, priced to your cost per mile.'),
 ('&#10052;','Reefer dispatch','Temperature-controlled produce and food lanes, appointment-tight.'),
 ('&#128736;','Flatbed &amp; step deck','Building materials, machinery and oversize with securement notes.'),
 ('&#9889;','Hotshot &amp; power-only','Nimble expedited and drop-and-hook, kept turning.'),
 ('&#128230;','Box truck dispatch','Local and regional box-truck freight for new and small operators.'),
 ('&#128643;','Owner-operator dispatch','One truck or a small fleet &mdash; a dedicated dispatcher who knows your equipment.'),
]))
dsp += m_zigzag('How managed dispatch works', 'From onboarding to loaded in days', [
 ('clipboard','You keep your authority','You stay the motor carrier of record with your own MC/DOT and insurance. LoadBoot dispatches as your agent &mdash; you are never re-brokered.'),
 ('bolt','We assign your dedicated dispatcher','The Command Center verifies your setup and assigns a screened, dedicated US truck dispatcher with a written per-carrier SOP: your lanes, minimum rate, equipment and home-time.'),
 ('shieldcheck','Loads booked, money direct','Brokers pay you (or your factor) directly &mdash; LoadBoot never touches freight money. We run the ledger and bill our flat 5% only on loads you actually get paid for.'),
], accent='#0883F7', soft=False)
dsp += _sec('Who it is for', 'New authority to small fleet', _cards([
 ('&#127381;','New-authority carriers','No broker relationships yet? A dispatcher gets you booked while your MC ages &mdash; see <a href="how-to-get-loads-with-new-authority.html">getting loads with new authority</a>.'),
 ('&#128100;','Owner-operators','Stop spending nights on the load board. A dedicated dispatcher keeps your one truck earning &mdash; see <a href="owner-operator-dispatch.html">owner-operator dispatch</a>.'),
 ('&#128101;','Small fleets','Scale coverage without hiring in-house dispatch; one dispatcher can manage several trucks on aligned lanes.'),
]))
dsp += _sec('Why LoadBoot dispatch', 'Honest, compliant, flat 5%', _cards([
 ('&#128178;','Flat 5% &mdash; only when you earn','No monthly retainer, no percentage games. You pay 5% on booked, delivered, paid loads &mdash; nothing when the truck sits. See <a href="how-much-does-a-truck-dispatcher-cost.html">what a dispatcher costs</a>.'),
 ('&#9878;','A dispatcher, not a broker','LoadBoot dispatchers work as your bona fide agent (FMCSA 88 FR 39368): booked under your authority, no allocation of your freight to other carriers, no money custody. See <a href="truck-dispatcher-vs-freight-broker.html">dispatcher vs broker</a>.'),
 ('&#128273;','No freight-money handling','Brokers pay you or your factor directly; LoadBoot only bills its own fee. Your linehaul never routes through us.'),
 ('&#128241;','Everything in one platform','Live tracking, documents, detention/TONU capture and one-receipt payables &mdash; the ops layer behind your dispatcher.'),
]))
dsp += ('<section class="bg-soft"><div class="wrap"><div class="sec-head center reveal"><div class="eyebrow">Work with us</div><h2>Want to BE a dispatcher?</h2></div>'
 ...
 'LoadBoot hires salaried US truck dispatchers (remote): base salary + per-truck + performance bonus, with strict screening and a paid trial. If you know DAT/Truckstop, FMCSA/HOS and how to negotiate a rate, apply on our '
 '<a href="careers.html">careers page</a>.</div></div></section>')
_dsp_faq_html, _dsp_faq_sch = faq_block([
 ...
 ('What equipment do you dispatch?', 'Dry van, reefer, flatbed and step deck, hotshot, power-only and box truck - for owner-operators and small fleets across the US.'),
 ('Can a new-authority carrier use a dispatcher?', 'Yes - a dispatcher is one of the fastest ways for a new-authority carrier to start getting loads while building broker relationships and credit.'),
])
...
<div class="ag-card reveal"><div class="n">2</div><h3>They join &amp; move freight</h3><p>Anyone who signs up through your link is tied to you &mdash; carrier, broker or shipper. The moment they move freight on LoadBoot, you&rsquo;re earning. No pairing to complete, no switch to flip.</p></div>
...
<div class="ag-card reveal"><div class="n">4</div><h3>Get paid monthly</h3><p>1% of gross on every GPS-verified delivered load your referred clients move. Payable after a 15-day clearing window, paid out monthly from $100. No invoices, no chasing.</p></div>
</div></div></section>
...
<div class="row"><label for="agChains">Clients you referred</label><output id="agChainsOut">3</output></div>
<input type="range" id="agChains" min="1" max="15" value="3">
<div class="row"><label for="agLoads">Loads per client / month</label><output id="agLoadsOut">15</output></div>
...
<div class="agc-out">
<div class="agc-tile"><span>Freight your clients move</span><b id="agGross">$99,000</b></div>
...
<div style="font-size:.85rem;color:#9fb3d1;margin-top:16px">Recurring &mdash; for as long as your clients keep moving freight. Refer other agents and earn override levels five deep (0.5%, 0.25%&hellip;).</div>
</div>
...
<div class="ag-card reveal"><h3>&#128101; 5 levels deep</h3><p>Recruit other agents: you earn overrides on their referrals too &mdash; 1% / 0.5% / 0.25% / 0.15% / 0.10% down five levels.</p></div>
</div>
...
_ag_faq_html, _ag_faq_sch = faq_block([
 ...
 ('When do I start earning?', 'As soon as a client you referred moves freight on LoadBoot. Every GPS-verified delivered load involving your referred clients credits 1% of the gross load value to your account - there is no pairing requirement.'),
...
def cta_row(pairs):
    return '<div class="ctarow" style="margin-top:22px">' + ''.join(
...
feat += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:88px 0 64px"><div class="wrap">'
 ...
 '<div class="ctarow" style="margin-top:26px"><a href="get-started.html" class="btn btn-primary">Create an account &rarr;</a><a href="how-it-works.html" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">How it works</a></div>'
...
lbx += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:84px 0 60px"><div class="wrap"><div class="lbx-grid2">'
 ...
 '<div class="ctarow" style="margin-top:24px"><a href="create-carrier-account.html" class="btn btn-primary">Find real loads &rarr;</a><a href="app/partner/" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">Post a load &mdash; broker / shipper</a></div>'
...
bkx += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:84px 0 60px"><div class="wrap"><div class="lbx-grid2">'
 ...
 '<div class="ctarow" style="margin-top:24px"><a href="create-carrier-account.html" class="btn btn-primary">Book your first load &rarr;</a><a href="load-board.html" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">See the load board first</a></div>'
...
def _acct_flagship(cfg):
    ...
    b += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:80px 0 56px"><div class="wrap"><div class="lbx-grid2">'
        ...
        '<div class="ctarow" style="margin-top:24px"><a href="' + cfg['cta'][1] + '" class="btn btn-primary">' + cfg['cta'][0] + '</a>'
...
_ACCT_AGENT = {'fname': 'create-agent-account.html', 'title': 'Create a Referral Partner Account — Earn 1% on Every Delivered Load | LoadBoot', 'desc': 'How LoadBoot agents join: free account, your referral link is ready at signup — refer brokers, carriers and shippers and earn 1% on every load they run, recurring, no cap, and it never costs your clients anything.', 'kicker': 'For referral partners', 'h1': 'Create your Referral Partner account &mdash; <span style="color:#4ade80">earn 1% on every load, forever</span>', 'intro': 'Bring the people; the software does the work. Your referral link is live the moment you sign up &mdash; refer a broker, carrier or shipper, and every delivered load they move lands your 1% automatically. Recurring, no cap, and it never costs your clients anything &mdash; your slice comes out of LoadBoot&rsquo;s own flat 5% fee. See the <a href="agents.html" style="color:#7dd3fc">agent program</a>.', 'ticks': ['1% on every delivered load &mdash; forever', 'No cap &middot; recurring', 'Costs your clients nothing'], 'cta': ('Create your Referral Partner account &rarr;', '/app/agent/'), 'hero_shot': ('agent-signup.webp', 1100, 773, 'Agent portal signup — free account with your referral link ready the moment you sign up', 'The real signup &mdash; free account, referral link ready the moment you join.'), 'steps_h': 'Signup to first commission in four steps', 'steps': [('Create the account', 'Email, name, mobile &mdash; agency or solo. Your referral link is ready the moment you sign up.'), ('They join and move freight', 'Share your link with brokers, carriers and shippers you know. The moment anyone you referred moves freight on LoadBoot, you are earning &mdash; no pairing to complete.'), ('They work, you earn', 'Every delivered load your referred clients move lands your 1% automatically &mdash; you can watch it hit the ledger the moment the POD is verified.'), ('W-9 and payout details', 'E-sign the W-9 and add bank details before your first payout &mdash; payouts run against real delivered loads, tracked live in your portal.')], 'docs_h': 'Have these ready', 'docs': [('&#9997;&#65039;', 'W-9', 'Your tax details &mdash; required before the first payout, e-signable in minutes.'), ('&#127974;', 'Payout details', 'Bank details for commission payouts.'), ('&#128101;', 'Your network', 'The real asset: brokers and carriers who trust you. The board&rsquo;s job is to keep them once they arrive.')], 'docs_note': '', 'shots_h': 'Real screens &mdash; your referrals, your 1%', 'shots': [('agent-dashboard.webp', 1100, 859, 'The agent dashboard — referral link, clearing balance and the 5-level commission math', 'The real dashboard &mdash; your link, your clearing balance, the 5-level math.'), ('agent-chain.webp', 420, 761, 'A referred broker and carrier on LoadBoot, a delivered load, and your 1% landed automatically', 'Your referrals &mdash; broker joined, carrier booked, POD verified, +$28.50 landed automatically.')], 'notes_k': 'Why agents win here', 'notes_h': 'A referral is only worth what the platform retains', 'notes': [('Retention is the commission', 'Your income is per-load, forever &mdash; so it depends on your people staying. Detention that pays, receipts that verify and a board with zero ghosts is what keeps them.'), ('Transparent math', '1% of every delivered load your referred clients move, tracked in the portal against real loads &mdash; not a spreadsheet someone emails quarterly.'), ('Never at your client&rsquo;s expense', 'Your slice comes from LoadBoot&rsquo;s own flat 5% fee. Brokers and carriers you bring pay exactly what everyone else pays.'), ('You look good', 'Same-day verification and onboarding reminders mean the people you send actually get through &mdash; and thank you for it.')], 'faq_h': 'Referral Partner account FAQ', 'faq': [('Who pays my commission?', 'LoadBoot does, from its own flat 5% dispatch fee. Your brokers and carriers never pay extra because you referred them.'), ('How much do I earn?', '1% of every delivered load your referred clients move &mdash; recurring for as long as they run on LoadBoot, with no cap.'), ('When are payouts?', 'Against delivered, verified loads &mdash; tracked live in your agent portal, paid to the bank details on file.'), ('Can dispatch agencies join?', 'Yes &mdash; solo referrers, dispatchers and agencies use the same program. See the <a href="agents.html">agent &amp; referral program</a>.')], 'cta_h': 'Bring the people. The software does the work.', 'cta2': [('The agent program', 'agents.html'), ('Referral details', 'referral.html')], 'related': [('agents.html', 'Agent Program'), ('referral.html', 'Referral Program'), ('carriers.html', 'For Carriers'), ('brokers.html', 'For Brokers'), ('compliance.html', 'Compliance & Verification'), ('contact.html', 'Contact')]}
...
pay += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:84px 0 60px"><div class="wrap"><div class="lbx-grid2">'
 ...
 '<div class="ctarow" style="margin-top:24px"><a href="create-carrier-account.html" class="btn btn-primary">Get paid like this &rarr;</a><a href="app/partner/" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">Pay with a paper trail &mdash; broker / shipper</a></div>'
...
fac += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:84px 0 60px"><div class="wrap"><div class="lbx-grid2">'
 ...
 '</div>'
 '<div class="ctarow" style="margin-top:22px"><a href="create-carrier-account.html" class="btn btn-primary">Set up factoring in minutes &rarr;</a><a href="payments-settlements.html" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">How payments work</a></div></div>'
...
flt += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:84px 0 60px"><div class="wrap"><div class="lbx-grid2">'
 ...
 '<div class="ctarow" style="margin-top:24px"><a href="create-carrier-account.html" class="btn btn-primary">Run your fleet on LoadBoot &rarr;</a><a href="features.html" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">All features</a></div>'
...
hiw += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:80px 0 46px"><div class="wrap"><div class="lbx-grid2">'
 ...
 '<div class="ctarow" style="margin-top:24px"><a href="get-started.html" class="btn btn-primary">Get started &mdash; any role &rarr;</a><a href="compliance.html" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">How verification works</a></div>'
...
hiw += ('<section class="ftx-sec alt" id="for-agents"><div class="wrap"><div class="lbx-grid2">'
 ...
 '<div class="ftx-li"><span class="ftx-tick">2</span><div><b>They join and move freight</b> &mdash; anyone you refer is tied to you, and the moment they move freight on LoadBoot you earn your 1%. No pairing to complete.</div></div>'
 '<div class="ftx-li"><span class="ftx-tick">3</span><div><b>Loads deliver, you earn</b> &mdash; 1% of every delivered load your referred clients move lands automatically after the POD verifies; 15-day clearing, monthly payouts to your verified account.</div></div>'
...
ccpub += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:80px 0 56px"><div class="wrap"><div class="lbx-grid2">'
 ...
 '<div class="ctarow" style="margin-top:22px"><a href="how-it-works.html" class="btn btn-primary">How the whole loop works &rarr;</a><a href="security.html" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">Security</a></div></div>'
...
sp += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:80px 0 56px"><div class="wrap"><div class="lbx-grid2">'
 ...
 '<div class="ctarow" style="margin-top:24px"><a href="create-shipper-account.html" class="btn btn-primary">Create a shipper account &rarr;</a><a href="contact.html#quote" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">Talk about your lanes</a></div>'
...
flb += _sec('The answer', 'Post free &mdash; and the software comes with it', _cards([
    ('&#127991;', 'Posting is free, forever', 'Create a broker account, post your load, reach verified carriers &mdash; no card, no tier, no per-post charge. LoadBoot earns from the carrier-side dispatch fee, never from you. <a href="create-broker-account.html">Create a broker account &rarr;</a>'),
    ('&#128225;', 'First-accept-wins offers', 'Your load reaches carriers that fit the lane and equipment. First acceptance wins and every other offer auto-closes &mdash; no double-booked trucks, no round of check calls. <a href="load-board.html">See the live load board &rarr;</a>'),
    ('&#128205;', 'Live GPS on every load', 'Geofenced arrive/depart stamps and a live map replace the &ldquo;where&rsquo;s my truck&rdquo; calls &mdash; the visibility other boards charge extra for, included. <a href="gps-tracking.html">See GPS tracking &amp; proof &rarr;</a>'),
...
flb += _sec('Why the board is clean', 'Verified carriers only &mdash; double-brokering has nowhere to hide', _cards([
    ...
    ('&#128203;', 'Insurance &amp; health tracked continuously', 'Certificates of insurance and account health are monitored over time, so a carrier that lapses tomorrow does not quietly stay eligible. <a href="compliance.html">How compliance is tracked &rarr;</a>'),
    ('&#128064;', 'The real truck, on the map', 'GPS on the assigned truck is your defense against double-brokering &mdash; the load moves on the carrier you booked, and the record proves it. <a href="load-board-subscription-cost.html">Why fake loads cost you &rarr;</a>'),
]))
flb += _sec('How it compares', 'A free load board vs a paid subscription',
 '<div class="reveal" style="max-width:840px;margin:0 auto 22px;font-size:1.05rem;line-height:1.85;color:var(--muted)">'
 '<p>Brokers search for a <b>free load board for brokers</b>, a <b>DAT alternative</b>, or a way to <b>post loads free with no subscription</b> for one reason: the paid boards are expensive and the fake loads waste your team&rsquo;s time. LoadBoot puts posting on the free side and bundles the software the paid boards charge extra for. Here is the honest comparison &mdash; and always confirm current competitor pricing yourself, because it changes.</p></div>'
 '<div style="overflow-x:auto"><table style="width:100%;max-width:840px;margin:0 auto;border-collapse:collapse;font-size:.95rem">'
 '<thead><tr><th style="text-align:left;padding:12px 14px;border-bottom:2px solid #e2e8f0"></th><th style="text-align:left;padding:12px 14px;border-bottom:2px solid #e2e8f0;color:#64748b">Paid load boards</th><th style="text-align:left;padding:12px 14px;border-bottom:2px solid #e2e8f0;color:#0883F7">LoadBoot</th></tr></thead><tbody>'
 '<tr><td style="padding:12px 14px;border-bottom:1px solid #eef2f7;font-weight:700">Cost to post</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">~$195&ndash;$345/mo + renewal hikes</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7"><b style="color:#0883F7">Free</b> &mdash; no subscription</td></tr>'
 '<tr><td style="padding:12px 14px;border-bottom:1px solid #eef2f7;font-weight:700">Ghost / fake loads</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">Common</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7"><a href="ghost-loads-load-board-problems.html">Zero &mdash; stale posts auto-close</a></td></tr>'
 '<tr><td style="padding:12px 14px;border-bottom:1px solid #eef2f7;font-weight:700">Carrier vetting</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">Your job</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7"><a href="compliance.html">FMCSA + insurance verified</a></td></tr>'
 '<tr><td style="padding:12px 14px;border-bottom:1px solid #eef2f7;font-weight:700">Tracking</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">Separate paid tool</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7"><a href="gps-tracking.html">Live GPS included</a></td></tr>'
 '<tr><td style="padding:12px 14px;font-weight:700">Payables</td><td style="padding:12px 14px">Separate TMS</td><td style="padding:12px 14px"><a href="payments-settlements.html">One-receipt payables included</a></td></tr>'
 '</tbody></table>'
 '<p class="reveal" style="max-width:840px;margin:20px auto 0;font-size:.95rem;color:var(--muted)">Want the full breakdown of what a subscription really costs &mdash; renewal hikes, add-ons, per-seat fees and the fake-load tax? Read <a href="load-board-subscription-cost.html">the real cost of load board subscriptions</a>.</p>', soft=True)
flb += _sec('New to brokering?', 'Start free, no card required',
 '<div class="reveal" style="max-width:840px;margin:0 auto;font-size:1.05rem;line-height:1.85;color:var(--muted)">'
 '<p>If you are a <b>new freight broker</b> building your carrier network, a paid subscription is a hard first cost before you have covered a single load. Posting free means you can put your freight in front of <b>verified carriers</b> from day one, with no ghost loads burning your first calls. Post your freight, cover it with vetted capacity, and only the carrier-side dispatch fee ever applies &mdash; never a charge to you. <a href="create-broker-account.html">Create a broker account</a> to start, or see how covering freight works end to end in <a href="brokers.html">the broker program</a>.</p></div>')
...
sdc += _sec('The answer', 'Direct pricing, with the vetting done for you', _cards([
    ('&#127991;', 'Post your freight free', 'Create a shipper account, post your lane, and verified carriers see it &mdash; no subscription, no posting fee. You pay the carrier for the haul, not a broker for the introduction. <a href="create-shipper-account.html">Create a shipper account &rarr;</a>'),
    ('&#128737;', 'Every carrier is verified', 'Authority, insurance and account health are checked before a carrier is ever offered your load &mdash; and monitored continuously, not photocopied once. The hardest part of going direct is handled for you. <a href="compliance.html">How carriers are verified &rarr;</a>'),
    ('&#128205;', 'Live GPS on every shipment', 'A live map, ETA and geofenced arrive/depart stamps answer &ldquo;where is my freight&rdquo; before anyone calls &mdash; and stand as server-side proof in any dock dispute. <a href="gps-tracking.html">See GPS tracking &amp; proof &rarr;</a>'),
    ('&#128179;', 'Clean, receipt-verified payments', 'Invoices ride a receipt-verified rail with PAY-BY deadlines and confirmations, so paying the carrier direct is as clean as paying a broker &mdash; with the paperwork trail to match. <a href="payments-settlements.html">How payments work &rarr;</a>'),
    ('&#128064;', 'Double-brokering protection', 'Because the assigned carrier is verified and GPS-tracked, your freight moves on the truck you booked &mdash; the single biggest defense against the double-brokering scams that hit direct shippers. <a href="protect-freight-from-loss-damage-and-fraud.html">Protect your freight &rarr;</a>'),
    ('&#127981;', 'Dock scheduling for facilities', 'Run appointments and geofenced check-ins at your own docks, measured the same way for every carrier &mdash; data to fix slow docks and defend against inflated detention claims. <a href="shipper-solutions.html">Shipper &amp; facility solutions &rarr;</a>'),
]))
...
sdc += _sec('The math', 'What shipping direct to carriers actually saves you',
 '<div class="reveal" style="max-width:840px;margin:0 auto 22px;font-size:1.05rem;line-height:1.85;color:var(--muted)">'
 '<p>When you ship through a broker, a middleman takes a cut on every load &mdash; commonly <b>15&ndash;20%</b> of the freight cost. Post your freight direct to a carrier and you pay the truck for the haul, not the broker for the introduction. Over a year of shipments that markup is real money leaving your business. That is why more shippers search for <b>how to ship without a broker</b>, the <b>cheapest way to ship a full truckload</b>, and a <b>direct shipper load board</b> &mdash; and why paying carriers directly is the single biggest lever on your freight spend. The catch has always been vetting and risk; LoadBoot removes it so going direct is safe. Read the full playbook in <a href="how-to-ship-without-a-broker.html">how to ship freight without a broker</a>.</p></div>'
 '<div style="overflow-x:auto"><table style="width:100%;max-width:840px;margin:0 auto;border-collapse:collapse;font-size:.95rem">'
 '<thead><tr><th style="text-align:left;padding:12px 14px;border-bottom:2px solid #e2e8f0"></th><th style="text-align:left;padding:12px 14px;border-bottom:2px solid #e2e8f0;color:#64748b">Through a broker</th><th style="text-align:left;padding:12px 14px;border-bottom:2px solid #e2e8f0;color:#0883F7">Direct on LoadBoot</th></tr></thead><tbody>'
 '<tr><td style="padding:12px 14px;border-bottom:1px solid #eef2f7;font-weight:700">What you pay</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">Freight + a 15&ndash;20% broker markup</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">The carrier&rsquo;s rate &mdash; posting is free</td></tr>'
 '<tr><td style="padding:12px 14px;border-bottom:1px solid #eef2f7;font-weight:700">Carrier vetting</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">The broker&rsquo;s job (you can&rsquo;t see it)</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">Authority + insurance <a href="compliance.html">verified for you</a>, continuously</td></tr>'
 '<tr><td style="padding:12px 14px;border-bottom:1px solid #eef2f7;font-weight:700">Visibility</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">Call for updates</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7"><a href="gps-tracking.html">Live GPS + arrive/depart proof</a></td></tr>'
 '<tr><td style="padding:12px 14px;border-bottom:1px solid #eef2f7;font-weight:700">Fraud / double-brokering</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">Hidden risk</td><td style="padding:12px 14px;border-bottom:1px solid #eef2f7">GPS on the booked truck &mdash; <a href="protect-freight-from-loss-damage-and-fraud.html">protection built in</a></td></tr>'
 '<tr><td style="padding:12px 14px;font-weight:700">Payment</td><td style="padding:12px 14px">Broker pays the carrier, bills you</td><td style="padding:12px 14px"><a href="payments-settlements.html">Receipt-verified</a>, direct to the carrier</td></tr>'
 '</tbody></table></div>', soft=True)
sdc += _sec('Any equipment, any lane', 'Reefer, dry van, flatbed &mdash; posted direct',
 '<div class="reveal" style="max-width:840px;margin:0 auto;font-size:1.05rem;line-height:1.85;color:var(--muted)">'
 '<p>Shippers post every kind of truckload freight direct on LoadBoot &mdash; <b>reefer</b> (temperature-controlled), <b>dry van</b>, <b>flatbed and step-deck</b>, <b>hotshot</b>, <b>power-only</b> and <b>box truck / expedited</b>. Whatever your lane, verified carriers running that equipment can see and accept it, so you find capacity without a broker sitting in the middle. If you run recurring lanes, a direct relationship with vetted carriers is both cheaper and more reliable than re-brokering every load. See the equipment types and how matching works in the <a href="shipper-solutions.html">shipper solution</a>, or <a href="create-shipper-account.html">create a shipper account</a> and post your first lane free.</p></div>')
...
intg += ('<section style="background:linear-gradient(165deg,#0e1c38 0%,#0b1220 60%,#0d1830 100%);color:#fff;padding:80px 0 56px"><div class="wrap"><div class="lbx-grid2">'
 ...
 '<div class="ctarow" style="margin-top:24px"><a href="create-carrier-account.html" class="btn btn-primary">Connect your books &rarr;</a><a href="/app/developer/" class="btn btn-secondary" style="background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.25)">Developer portal &amp; API keys</a></div>'
