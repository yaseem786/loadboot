...
_ACCT_AGENT = {'fname': 'create-agent-account.html', 'title': 'Create an Agent Account — Earn From Every Load Your Carriers Haul | LoadBoot', 'desc': 'How referral agents join LoadBoot: W-9 and payout details, your referral link, and recurring commissions paid from LoadBoot&rsquo;s own 5% dispatch fee — your carriers never pay more.', 'kicker': 'For referral &amp; sales agents', 'h1': 'Create your agent account &mdash; <span style="color:#4ade80">earn from every load your carriers haul</span>', 'intro': 'Refer carriers onto a board that treats them right, and earn a slice of LoadBoot&rsquo;s own 5% dispatch fee on every load they haul &mdash; month after month. Your carriers never pay extra; commissions come out of our side, and your tiers are confirmed in writing at signup. See the <a href="agents.html" style="color:#7dd3fc">agent program</a>.', 'ticks': ['Commissions from LoadBoot&rsquo;s fee &mdash; never the carrier&rsquo;s', 'Recurring, per-load, in writing', 'Free to join'], 'cta': ('Create your agent account &rarr;', '/app/agent/'), 'hero_shot': ('board-web-available.webp', 1100, 773, 'The live load board your referred carriers get — verified loads with the full rate card', 'What you are selling &mdash; a real board: verified loads, rate card in writing, zero ghosts.'), 'steps_h': 'Signup to first commission in four steps', 'steps': [('Create the account', 'Sign up in the Agent Portal with your email — solo agents and agencies both welcome.'), ('W-9 and payout details', 'Tax form and where commissions land. Your tier schedule is confirmed in writing at signup — no handshake math.'), ('Get your referral link', 'Share it with carriers you know. When they sign up through it, they are tagged to you — permanently, not for 30 days.'), ('Earn on every load', 'Each load your carriers haul pays your slice from LoadBoot&rsquo;s own 5% fee. Track carriers, loads and payouts live in the portal; onboarding reminders help your referrals finish verification.')], 'docs_h': 'Have these ready', 'docs': [('&#9997;&#65039;', 'W-9', 'Your tax details — required before the first payout, e-signable in minutes.'), ('&#127974;', 'Payout details', 'Bank details for commission payouts.'), ('&#128101;', 'Your carrier network', 'The real asset: carriers who trust you. The board&rsquo;s job is to keep them once they arrive.')], 'docs_note': '', 'shots_h': 'Real screens &mdash; what your referrals get', 'shots': [('pay-money-in-phone.webp', 420, 909, 'Carrier money-in view — every dollar owed with deadlines and GPS-proven claims', 'Their money-in &mdash; deadlines, receipts, GPS-proven claims. Carriers stay for this.'), ('track-phone-map.webp', 420, 909, 'The live trip map with route and ETA', 'The trip map &mdash; the product that makes your referrals stick.')], 'notes_k': 'Why agents win here', 'notes_h': 'A referral is only worth what the platform retains', 'notes': [('Retention is the commission', 'Your income is per-load, forever — so it depends on carriers staying. Detention that pays, receipts that verify, and a board with zero ghosts is what keeps them hauling.'), ('Transparent math', 'Tiers in writing at signup; payouts tracked in the portal against real hauled loads — not a spreadsheet someone emails quarterly.'), ('Never at your carrier&rsquo;s expense', 'Commissions come from LoadBoot&rsquo;s own fee. Your referrals pay the same flat 5% as everyone else.'), ('You look good', 'Onboarding reminders and same-day verification mean the carriers you send actually get through — and thank you for it.')], 'faq_h': 'Agent account FAQ', 'faq': [('Who pays my commission?', 'LoadBoot does, from its own 5% dispatch fee. The carrier&rsquo;s cost never changes because you referred them.'), ('How long do I earn on a referral?', 'As long as they haul on LoadBoot — commissions are recurring per load, not a one-time bounty.'), ('When are payouts?', 'Monthly, against loads actually hauled — tracked live in your portal. Details are in your written tier schedule.'), ('Can dispatch agencies join?', 'Yes — solo referrers, dispatchers and agencies all use the same program. See the <a href="agents.html">agent &amp; referral program</a>.')], 'cta_h': 'Your network. Recurring income. In writing.', 'cta2': [('The agent program', 'agents.html'), ('Referral details', 'referral.html')], 'related': [('agents.html', 'Agent Program'), ('referral.html', 'Referral Program'), ('carriers.html', 'For Carriers'), ('market-rates.html', 'Market Rates'), ('compliance.html', 'Compliance & Verification'), ('contact.html', 'Contact')]}

for _cfg in (_ACCT_CARRIER, _ACCT_BROKER, _ACCT_SHIPPER, _ACCT_AGENT):
    _acct_flagship(_cfg)

# ---------- COMPLIANCE & VERIFICATION HUB ----------
_cmp_faq = [('What does LoadBoot actually verify?', 'Role-appropriate federal records and documents: carrier MC/USDOT status and insurance, broker authority and the federal bond, plus every uploaded document — checked for the right named party and a live expiry date, on a visible review tracker.'), ('How long does verification take?', 'Document review typically completes the same day. Federal-record checks (FMCSA authority, bond) are automatic at signup.'), ('What happens when a document expires?', 'The vault warns before expiry. If a required document lapses, booking or posting gates pause until a fresh one is approved — problems surface before a load, never during one.'), ('Are e-signatures legally valid?', 'Yes — the dispatch agreement and W-9 are signed in-app under the E-SIGN Act, with PDFs generated instantly and stored on the account.'), ('Is anyone unvetted on the board?', 'No. Carriers pass authority, insurance and health checks before they see freight; posting requires licensed broker (or verified shipper) status. Both sides of every load are verified — that is the whole point.')]
_cmp_schema = '<script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What does LoadBoot actually verify?", "acceptedAnswer": {"@type": "Answer", "text": "Role-appropriate federal records and documents: carrier MC/USDOT status and insurance, broker authority and the federal bond, plus every uploaded document \\u2014 checked for the right named party and a live expiry date, on a visible review tracker."}}, {"@type": "Question", "name": "How long does verification take?", "acceptedAnswer": {"@type": "Answer", "text": "Document review typically completes the same day. Federal-record checks (FMCSA authority, bond) are automatic at signup."}}, {"@type": "Question", "name": "What happens when a document expires?", "acceptedAnswer": {"@type": "Answer", "text": "The vault warns before expiry. If a required document lapses, booking or posting gates pause until a fresh one is approved \\u2014 problems surface before a load, never during one."}}, {"@type": "Question", "name": "Are e-signatures legally valid?", "acceptedAnswer": {"@type": "Answer", "text": "Yes \\u2014 the dispatch agreement and W-9 are signed in-app under the E-SIGN Act, with PDFs generated instantly and stored on the account."}}, {"@type": "Question", "name": "Is anyone unvetted on the board?", "acceptedAnswer": {"@type": "Answer", "text": "No. Carriers pass authority, insurance and health checks before they see freight; posting requires licensed broker (or verified shipper) status. Both sides of every load are verified \\u2014 that is the whole point."}}]}</script>'
...
flt += ('<section class="ftx-sec"><div class="wrap"><div class="sec-head reveal"><div class="eyebrow">Built into the same rail</div><h2>The back office that runs itself</h2></div>'
 ...
 '<div class="card"><div class="icon">&#128506;</div><h3>Fleet optimization</h3><p>Deadhead and utilization insights from your actual delivered trips &mdash; which trucks earn, which sit, and the lanes that pay.</p></div>'
...
intg += docsec('Live today', 'Developer platform',
 ...
 '<p><b>ELD &amp; telematics — two ways, both live</b>: (1) <b>direct connection</b> — paste your own Samsara API token or Motive API key and LoadBoot polls your trucks every 5 minutes, feeding the active trip automatically; (2) <b>secure webhook</b> — any device that can POST a position. Either way your trucks track themselves even with the app closed. (Carrier portal &rarr; Fleet &rarr; ELD &amp; telematics.)</p>'
 '<p><b>QuickBooks-compatible accounting export</b> — one click exports invoices (gross/fee/net), every expense and confirmed payments as clean CSVs that import into QuickBooks, Xero, Wave or your accountant&rsquo;s workflow. (Finance &rarr; Taxes.)</p>'
 '<p><b>Fuel card statement import</b> — drop the transactions CSV from EFS, Comdata or WEX and every purchase lands as a fuel expense, feeding P&amp;L and cost-per-mile. (Finance &rarr; Costs.)</p>'
 '<p><b>Fleet optimization analytics</b> — per-truck utilization, $/mile and your best-paying lanes computed from real delivered trips. (Fleet tab.)</p>')
intg += docsec('On the roadmap — not live yet', 'Honest list',
 '<p>Still ahead, and <b>not</b> part of the product today: <b>native OAuth sync</b> with QuickBooks Online (two-way, no CSV), <b>fuel-card provider APIs</b> (beyond statement import), and <b>multi-fleet enterprise optimization</b>. When each ships it will be documented here first. Want one prioritized? <a href="contact.html">Tell us</a> — real demand moves the roadmap.</p>'
