...
.links5{display:grid;grid-template-columns:repeat(7,1fr);gap:22px;margin-bottom:40px}
...
AI_RESEARCH_BLOCK = '<div id="aiResearch">\n<style>#aiBtns a{display:flex;align-items:center;gap:9px;padding:5px 0;font-size:.95rem;color:#cbd5e1;margin:0}#aiBtns a:hover{color:#fff}#aiBtns .ai-chip{flex:none;width:26px;height:26px;border-radius:50%;background:#1e293b;border:1px solid #334155;display:flex;align-items:center;justify-content:center;color:#e2e8f0}#aiBtns .ai-arw{opacity:.35;font-size:.85em}#aiBtns a:hover .ai-arw{opacity:.9}</style>\n<div class="foot-h">Ask AI for info</div>\n<div id="aiBtns" role="group" aria-label="Open an AI assistant with a research prompt about LoadBoot"></div>\n<pre id="aiPromptText" hidden style="display:none"></pre>\n<button type="button" id="aiCopyBtn" hidden style="display:none">Copy prompt</button>\n<span id="aiCopyLive" class="sr-only" role="status" aria-live="polite"></span>\n</div>'
...
''' + (AI_RESEARCH_BLOCK if AI_RESEARCH_FOOTER_ENABLED else '') + '''</div>
