-- READ-ONLY SOURCE SNAPSHOT. Not a production migration or an approved rollout.
-- Retrieved from staging on 2026-09-12. Production lacks both function names.
-- Requires current dependency/grant review and rollback tests before promotion.
-- In particular, verify app_private.outreach_contacts.opened_at; do not run the
-- original bl_out_0308 batch, which also changes outreach control/send behavior.

-- cc_outreach_audience md5=ec52b049ffac878ad22571d8e46bc41c
...
-- cc_outreach_log_page md5=e7c8099698133d28de3c9c8601a777a2
-- ACL {postgres=X/postgres,authenticated=X/postgres,service_role=X/postgres}
