...
6. **Own agents (Ali Raza, Usman, Asim, Charanpreet):** they have no parent MC and LoadBoot has none — they stay unable to post until a partner brokerage confirms them, or you decide to obtain broker authority. Decide this. **Decided 26 Sep: no authority for now — all four converted to agents (`bl_bp_0454`, audit §7 item 8); they post only once a partner brokerage confirms them.**
