...
<div class="pv-stamp"><b>These are the LoadBoot Terms of Service.</b> Last updated <b>6 September 2026</b> &middot; a binding agreement between you and LoadBoot LLC &middot; read with our <a href="privacy.html" style="color:#7dd3fc">Privacy Policy</a>, which forms part of it</div>
    ...
    C.append(_clause(11, 'Privacy &amp; text messages', [
        ...
        '<b>Text messages (SMS).</b> We text you only if you tick the optional SMS box under the mobile number field when you register in the carrier portal. That box is unchecked by default and ticking it is not required to create an account. If you tick it, you agree to receive one-to-one operational text messages from LoadBoot about loads and dispatch: load details, pickup and delivery information, check-call and status updates, paperwork requests and replies to your messages. We do not send marketing texts. Message frequency varies. Message and data rates may apply. Reply STOP to opt out at any time, START to opt back in, and HELP for help, or contact <a href="mailto:hello@loadboot.com">hello@loadboot.com</a>. Consent to receive texts is not a condition of any purchase. Mobile carriers are not liable for delayed or undelivered messages. Mobile numbers and opt-in data are not shared with third parties for marketing &mdash; see the <a href="privacy.html#sms">Privacy Policy</a>.'],
